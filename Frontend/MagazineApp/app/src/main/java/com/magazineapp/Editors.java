...
/**
 * Load stories and either publish, decline and set photos
 */
public class Editors extends BaseActivity {
    ...
    private void loadData() throws JSONException {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, App.ENDPOINT, response -> {
            ...
            protected Map<String, String> getParams() {
                return getParameters("getallstory");
            }
        };
    ...
    private void loadData_1() throws JSONException {
        ...
        jsonObject.put("action", "getallstory");
        pg.setVisibility(View.VISIBLE);
