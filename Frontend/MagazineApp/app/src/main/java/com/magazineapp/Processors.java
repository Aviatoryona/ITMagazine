...
/**
 * Load adverts and either approve or decline
 */
public class Processors extends BaseActivity {
    ...
    private void loadData() throws JSONException {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, App.ENDPOINT, response -> {
            ...
            protected Map<String, String> getParams() {
                Map<String, String> params = getParameters("getadvertbystatus");
                params.put("status", "1");
                return params;
            }
        };
    ...
    private void loadData_1() throws JSONException {
        ...
        jsonObject.put("action", "getadvertbystatus");
